...
const serverUrl = "https://dfzv8sqxyyou.usemoralis.com:2053/server"; //Moralis Server Url here
const appId = "iVkAkL1Na7w15AL2LkRvHLjNFGkweHL5POXDPboS"; //Moralis Server App ID here
...
const chainId = "bsc";
const collectionAddress = "0x89bd6e2304e431B5BF9a999f99D7912e68a9f5ec"; //Collection Address Here
const collectionName = "CryoPunks"; //CollectioonName Here


async function generateRarity() {
  const NFTs = await Moralis.Web3API.token.getAllTokenIds({address: collectionAddress, chain: "bsc",});
  ...
  for(let i = pageSize; i < totalNum; i = i + pageSize){
    const NFTs = await Moralis.Web3API.token.getAllTokenIds({ chain: chainId,	address: collectionAddress, cursor: cursor, });
